                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <div class="header-title">
                                    <h4 class="card-title">Country Data</h4>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <form action="{{ route('countries.store')}}" method="POST">
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" name="name" class="form-control" id="fname" placeholder="Country Name">
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label class="form-label" for="lname">Code</label>
                                                <input type="text" name="code" class="form-control" id="lname" placeholder="Country Code">
                                            </div>
