                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">تعديل قطاع</h4>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <form action="{{ route('dashboard.sectors.update', $sector->id)}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label class="form-label" for="fname">اسم القطاع بالعربي</label>
                                        <input type="text" name="name_ar" value="{{ $sector->name}}" class="form-control" id="fname">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label class="form-label" for="lname">اسم القطاع بالانجليزي</label>
                                        <input type="text" name="name_en" value="{{ $sector->name_en}}" class="form-control" id="lname">
                                    </div>
                                ...
                                <button type="submit" class="btn btn-primary">تعديل القطاع</button>
                            </form>
                        </div>
                    </div>
                </div>
