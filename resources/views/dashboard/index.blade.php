                                    ...
                                    <div class="card-body">
                                        <div class="progress-widget">
                                            ...
                                            <div class="progress-detail">
                                                <p class="mb-2">عدد الفرص</p>
                                                <h4 class="counter">{{ $opportunties }}</h4>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="900">
                                    <div class="card-body">
                                        <div class="progress-widget">
                                            ...
                                            <div class="progress-detail">
                                                <p class="mb-2">عدد طلبات الاستثمار</p>
                                                <h4 class="counter">{{ $invistiments }}</h4>
                                            </div>
                                        </div>
                                    </div>
                                </li>
