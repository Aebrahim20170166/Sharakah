                        ...
                        <a href="./opportunitiesDetails.html">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <img class="card-img" src="./assets/images/SVG/card1_image.svg" />
                                    <div class="small-box-info d-flex align-items-center gap-1 p-1"
                                        style="font-size: 14px; background-color: #F6F6F6;">
                                        <img class="card-icon" src="./assets/images/SVG/location.svg" />
                                ...
                                <div class="title">
                                    ...
                                    <div class="small-box-info d-flex align-items-center gap-2"> <img class="card-icon"
                                            src="./assets/images/SVG/burger.svg" /> {{ $opportunity->sector->name }}</div>
                                </div>
                                <div class="card-list">
                                ...
                                <button type="button" class="btn card-btn d-flex align-items-center"><img
                                        class="card-icon-small" src="./assets/images/SVG/arrow.svg" />
                    ...
                    <div class="item">
                        <div class="section-card text-center p-4 rounded-3 bg-light">
                            <div class="d-flex align-items-start justify-content-between">
                                <img src="{{ asset('assets/images/SVG/hotel.svg') }}" style="width:60px; height: 60px;">
