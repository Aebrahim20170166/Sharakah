    ...
    <div class="login-left flex-grow-1">
      <div class="login-form-box">
        <div class="login-avatar mb-2">
          <svg width="48" height="48" fill="none" stroke="#1E4262" stroke-width="2" viewBox="0 0 24 24">
        ...
        <form action="{{route('web.login')}}" method="POST">
          ...
          <div class="mb-2">
            ...
            <div class="input-group">
              ...
              <span class="input-group-text">
                <svg width="20" height="20" fill="none" stroke="#1E4262" stroke-width="2" viewBox="0 0 24 24">
